...
public class MontadorCaverna{
      ...
      void criaCaverna(String stringCaverna[][]){
            for(int k = 0; k < stringCaverna.length; k++){
                  ...
                  this.cavernaMontada[i][j] = new Sala(i, j, simbolo);
            }
                  ...
                  if(simbolo == 'B' || simbolo == 'W'){
                        ...
                        for(int a = 0; a < 4; a++){
                              ...
                              if( safe ){
                                    ...
                                    char c_aux = cavernaMontada[pi][pj].getSimbolo(false);
                                    if(c1 && (c_aux != 'B' && c_aux != 'W')){
                                          this.cavernaMontada[pi][pj] = new Sala(pi, pj, simbolo_arredores);
                                    }
                              }
                        }
                  }
