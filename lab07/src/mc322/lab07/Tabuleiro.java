...
public class Tabuleiro extends JPanel{
      ...
      protected void paintComponent(Graphics g){
            ...
            setBackground(new Color(38, 38, 43));
            ...
            for(int i = lin; i >= 0; i--){
                  for(int j = 0; j <= col; j++){
                        Desenha(i, j, "tiles/tile01.png", g);
                  }
            }

            Desenha(lin+1, -1, "tiles/tile01.png", g);
            Desenha(lin+2, -2, "tiles/tile01.png", g);

            for(int i = lin-1; i > 0; i--){
                  if(i == 7) continue;
                  Desenha(i+1, -1, "tiles/left_wall.png", g);
                  Desenha(i+2, -2, "tiles/left_wall.png", g);
            }

            Desenha(1, -1, "tiles/tile01.png", g);
            Desenha(2, -2, "tiles/tile01.png", g);

            for(int j = 1; j < col; j++){
                  if(j == 6) continue;
                  Desenha(col+1, j-1, "tiles/right_wall.png", g);
                  Desenha(col+2, j-2, "tiles/right_wall.png", g);
            }

            Desenha(col+1, col-1, "tiles/tile01.png", g);
            Desenha(col+2, col-2, "tiles/tile01.png", g);
